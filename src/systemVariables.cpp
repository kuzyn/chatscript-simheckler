...
static char* Sforeign(char* value)
{
	...
	if (value) 
	{
		if (!stricmp(value,"1")) tokenFlags |= FOREIGN_TOKENS;
...
static char* Squestion(char* value) 
{
	...
	if (value) 
	{
		if (!stricmp(value,"1")) tokenFlags |= QUESTIONMARK;
...
static char* Scommand(char* value) 
{
	...
	if (value) 
	{
		if (!stricmp(value,"1")) tokenFlags |= COMMANDMARK;
...
static char* Squotation(char* value) 
{
	...
	if (value) 
	{
		if (!stricmp(value,"1")) tokenFlags |= QUOTATION;
...
static char* Simpliedyou(char* value) 
{
	...
	if (value) 
	{
		if (!stricmp(value,"1")) tokenFlags |= IMPLIED_YOU;
...
static char* Stense(char* value) 
{
	...
	if (value) 
	{
		if (!stricmp(value,"past")) {tokenFlags &= -1 & (PRESENT|FUTURE); tokenFlags |= PAST;}
...
static char* SuserInput(char* value) 
{
	...
	if (value) 
	{
		if (!stricmp(value,"1")) tokenFlags |= USERINPUT;
...
static char* Svoice(char* value) 
{
	...
	if (value) 
	{
		if (!stricmp(value,"1")) tokenFlags |= PASSIVE;
